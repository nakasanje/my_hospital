...
class _PayableState extends State<Payable> {
  ...
  Future<QuerySnapshot<Map<String, dynamic>>> _getPayableAppointments() async {
    setState(() {
      _loading = true;
    });
    ...
    final QuerySnapshot<Map<String, dynamic>> snapshot = await FirebaseFirestore
        ...
        .where('list_type', isEqualTo: 'payable')
        .get();

    setState(() {
      _loading = false;
      _payableAppointments = snapshot.docs.map((doc) => doc.data()).toList();
    });
  ...
  Future<void> _cancelAppointment(appointmentId) async {
    setState(() {
      _loading = true;
    });
  ...
  Future<void> _makePayment() async {
    ...
    // Your payment code using Stripe or any other payment service goes here

    // Assuming the payment is successful, you can update the payment status in Firestore
    final paymentData = {
      'amount': '500000',
      'currency': 'lkr',
  ...
  Future<void> _markAsPaid(String appointmentId) async {
    setState(() {
      _loading = true;
    });
    ...
    try {
      ...
      print('Failed to mark appointment as paid: $error');
    }
  }
                                                  ...
                                                  return DropdownMenuItem<
                                                    ...
                                                    onTap: () {
                                                      ...
                                                      if (value == 'View') {
                                                        ...
                                                        _makePayment()
                                                            .then((_) {
                                                          _markAsPaid(_payableAppointments[
                                                                      index][
                                                                  'appointment_id'])
                                                              .then((_) {
                                                            Fluttertoast
                                                            ...
                                                            Fluttertoast
                                                                .showToast(
                                                              msg:
                                                                  'Failed to mark appointment as paid: $error',
                                                              backgroundColor:
                                                                  Colors
                                                                      .red[600],
                                                              textColor:
